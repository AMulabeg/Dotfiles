...
accent_subtle=$(get_tmux_option "@minimal-tmux-accent-subtle" '#3a3a3a')      # active tab background
accent_text=$(get_tmux_option "@minimal-tmux-accent-text" '#d0d0d0')         # active tab text
accent_indicator=$(get_tmux_option "@minimal-tmux-accent-indicator" '#6c6c6c') # prefix indicator
accent_session=$(get_tmux_option "@minimal-tmux-accent-session" '#5f8787')    # session name
